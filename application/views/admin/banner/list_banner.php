    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading text-right"><button onclick="location.href ='<?= base_url('admin/banner/add'); ?>'" type="button" class="btn btn-primary">Add <?= $title; ?></button></div>
                <!-- /.panel-heading -->
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr class="<?= ($value['unique_id'] %2)?'even':'odd'; ?>">
                                    ...
                                    <td class="text-center"><img src="<?= base_url('assets/images/banner/thumbs/' .$value['banner_image']); ?>" /></td>
