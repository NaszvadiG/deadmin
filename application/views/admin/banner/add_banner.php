<div id="page-wrapper">
    <div class="row">
        ...
        <div class="col-lg-12">
            <form action="<?= base_url('admin/banner/add'); ?>" name="bannerForm" method="POST" role="form" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class='form-group'>
                                    ...
                                    <input type="radio" name="flag" value="1" checked="" /><label><span class="green-flag"></span>Active</label><br />
                                    <input type="radio" name="flag" value="2" /><label><span class="red-flag"></span>Inactive</label><br />
                    </div>
                            </div>
                        </div>
                        <div class="row">
